 ...
 * Created on February 9, 2022, 4:27 AM                                    *     
 * Purpose: Project 2: Yahtzee Game. Progressed from V2.3.1 to V2.3.2 so    *
 *                     I can revert back to previous version (V2.3.1) if    *
 *                     the following changes somehow irrevocably mess up    *
 *                     the program. Finishing transition to arrays. Small   *
 *                     bugs introduced into program in last version upon    *
 *                     switching to arrays, so debugging those is another   *
