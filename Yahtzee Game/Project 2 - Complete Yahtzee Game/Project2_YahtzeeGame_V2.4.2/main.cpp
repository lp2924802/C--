 ...
 * Created on February 9, 2022, 12:34 PM                                     *     
 * Purpose: Project 2: Yahtzee Game. Working on integrating printing to     *
 *                     scorecard.                                           *
 ***************************************************************************/
 ...
 *      1.10 Print Scores to Scorecard                                      *
 ***************************************************************************/
...
int scoreFn(int, int[], bool[]); //1.9 Score Dice
int getIndx(char, bool[]); //1.9.1 Get Index
int scoreUS(int, int[]); //1.9.? Score Upper Section
void prntSc(int[],fstream&,const int); //1.10 Print Scores to Scorecard
    ...
    while (ready=='y' || ready=='Y'){
        ...
        while (!all){ //While all scorecard spaces NOT filled
            ...
            for (rollCt=1; rollCt<=nRolls; rollCt++) {
                ...
                if (ytzChk==5 && !fullSp[11]){
                    cout<<"\n\t"<<left<<setw(63)<<"           "
                            "                    Yahtzee!\n";  
                }
                else if (ytzChk==5 && fullSp[11]){
                    cout<<"\n\t"<<left<<setw(63)<<"         "
                            "                   Yahtzee Bonus!\n";
                } //End Yahtzee Check****************************************
            ...
            numSp[indxVal] = scoreFn(indxVal,dice, fullSp);
...
//1.9 SCORE DICE
int scoreFn(int indx, int dice[], bool full[]){
...
//1.9.1 Get Index
/****************************************************************************
 *   Name:   scoreUS(char box, bool taken[]) --> Get Index                  *
...
//1.10 PRINT SCORES TO SCORECARD
void prntSc(int scores[], fstream &card, const int VALS){
