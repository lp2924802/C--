 ...
 * Created on February 9, 2022, 8:30 AM                                     *     
 * Purpose: Project 2: Yahtzee Game. All bugs caused by transition to       * 
 *                     arrays have now been resolved. Program is now able   *
 *                     to correctly calculate dice roll scores for the      *
 *                     "Upper" Section. Next steps are figuring out how to  *
 *                     print scores onto scorecard and developing the       *
 *                     logic for the "Lower" Section scoring.               *
 ***************************************************************************/
