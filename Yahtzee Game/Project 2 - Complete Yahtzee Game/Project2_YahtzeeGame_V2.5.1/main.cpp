 ...
 * Created on February 10, 2022, 12:34 AM                                    *     
 * Purpose: Project 2: Yahtzee Game. Making number display on scorecard     *
 *                     a bit neater looking. Resolving bugs in the          *
 *                     Yahtzee checker and the while !all gameplay loop.    *
 ***************************************************************************/
...
void getCard(fstream &card, int scores[], bool taken[]){
    ...
    card<<"\u2551"<<left<<setw(16)<<"     Yahtzee"<<"\u2551"<<right
            <<setw(4)<<scLb[13]<<"\u250a"<<right<<setw(4)<<scLb[14]
            <<"\u250a"<<setw(4)<<scLb[15]<<"\u250a"
            <<setw(2)<<scLb[16]<<"\u2551\n";
...
int scoreFn(int &indx, int dice[], bool full[], int vals[]){
    ...
    while (full[indx]){
        cout<<"\t ERROR: This space is already full. Please choose a different"
                " space: ";
        cin>>inp; //Get input
