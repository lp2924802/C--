 ...
 * Created on February 6, 2022, 6:49 PM                                     *     
...
//void dspDice(int[],const int[], string[],int); //1.8 Display Dice
        ...
        while (!all){ //While all scorecard spaces NOT filled
            ...
            for (int i=0; i<NUM; i++){
                ...
                cout<<"\t\u2551"<<right<<setw(16)<<"\u2551"<<right<<setw(6)
                        <<* strDice[0]<<setw(6)<<"\u250a"<<setw(6)<<* strDice[1]<<setw(6)
                        <<"\u250a"<<setw(6)<<* strDice[2]<<setw(6)<<"\u250a"<<setw(6)
                        <<* strDice[3]<<setw(6)<<"\u250a"<<setw(6)<<* strDice[4]<<setw(6)
                        <<"\u2551"<<endl;
...
//1.8 DISPLAY DICE
void dspDice(int dice[], const int D_VAL[], int rollCt){
       //Display dice roll
                //First bold border
                cout<<"\t\u2554";
                for (int q=0; q<63; q++){
