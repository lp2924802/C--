 ...
 * Purpose: Project 1: Yahtzee Game. Front half of game now complete. Score    *
 *          logic is next step in the development of this game.                *
 ******************************************************************************/


//Libraries
#include <cstdlib> //Random Number Library
#include <ctime> //Time Libraryn
 ...
 ******************************************************************************/
void getIntro(); //1.1 Game Introduction --> NEEDS TO BE WRITTEN
void yesNo(char&); //1.2 Yes/No Input Validation
void getCard(int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int); //1.3 Get Scorecard
...
int main(int argc, char** argv) {
    ...
    while (ready=='y' || ready=='Y'){
        ...
        //Clear screen and output scorecard
        ...
        while (!all){ //While all scorecard spaces NOT filled
            ...
            for (roll=1; roll<=nRolls; roll++){
                ...
                if (roll<nRolls){
                    ...
                    while (turn=='1' || turn=='2' || turn=='3' || turn=='4' || turn=='5'){
                        ...
                        //Clear screen and output new card + dice
                        cout<<"\033[2J\033[1;1H";
                        getCard(num1US,num2US,num3US,num4US,num5US,num6US,tot1t6,bonUS,totUS,num3k,num4k,numFH,numSmS,numLgS,numYtz,numChc,ytzB1,ytzB2,ytzB3,ytzB4,ytzBtot,totLS,grTot); 
            ...
            //Clear screen and redisplay card
            cout<<"\033[2J\033[1;1H";
            getCard(num1US,num2US,num3US,num4US,num5US,num6US,tot1t6,bonUS,totUS,num3k,num4k,numFH,numSmS,numLgS,numYtz,numChc,ytzB1,ytzB2,ytzB3,ytzB4,ytzBtot,totLS,grTot); 
...
void getCard(int aces, int twos, int threes, int fours, int fives, int sixes, int totNum, int bonUS, int totUS, int kind3, int kind4, int fHouse, int smSt, int lgSt, int ytz, int chance, int yb1, int yb2, int yb3, int yb4, int ybTot, int totLS, int grTot){
    ...
    cout<<"\t/\\' .\\    _____  \\ \\ / /  __    | |__   | |_   ____   ___    __ \u2551"<<endl;
    cout<<"       /: \\___\\  / .  /\\  \\ V /  / _` | | '_ \\  | __| |_  /  / _ \\  / _ \\ "<<endl;
    cout<<"       \\' / . / /____/..\\  | |  | (_| | | | | | | |_   / /  |  __/ |  __/"<<endl;
    cout<<"\t\\/___/  \\'  '\\  /  |_|   \\__,_| |_| |_|  \\__| /___|  \\___|  \\___|"<<endl;   
    cout<<"\t\u2551        \\'__'\\/                                                \u2551"<<endl; 
    ...
    cout<<"\t\u2551"<<left<<setw(16)<<"      Aces"<<"\u2551"<<right<<setw(7)<<*sAces<<"     \u2551\u2551"<<left<<setw(16)<<"  3 of a kind"<<"\u2551"<<right<<setw(9)<<*sKind3<<"      \u2551"<<endl;
    ...
    cout<<"\t\u2551"<<left<<setw(16)<<"      Twos"<<"\u2551"<<right<<setw(7)<<*sTwos<<"     \u2551\u2551"<<left<<setw(16)<<"  4 of a kind"<<"\u2551"<<right<<setw(9)<<*sKind4<<"      \u2551"<<endl;
    ...
    cout<<"\t\u2551"<<left<<setw(16)<<"     Threes"<<"\u2551"<<right<<setw(7)<<*sThrees<<"     \u2551\u2551"<<left<<setw(16)<<"   Full House"<<"\u2551"<<right<<setw(9)<<*sFHouse<<"      \u2551"<<endl;
    ...
    cout<<"\t\u2551"<<left<<setw(16)<<"      Fours"<<"\u2551"<<right<<setw(7)<<*sFours<<"     \u2551\u2551"<<left<<setw(16)<<"  SM Straight"<<"\u2551"<<right<<setw(9)<<*sSmSt<<"      \u2551"<<endl;
    
    cout<<"\t\u255f\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u256b\u2508\u2508"
            "\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2562\u2551"<<left<<setw(16)<<" (sequence of 4)"<<"\u2551"<<right<<setw(18)<<"\u2551"<<endl;
    
    //****************************FIVES - SUM OF ALL 5'S********************LARGE STRAIGHT - 40 PTS IF SEQUENCE OF 5*************************
    cout<<"\t\u2551"<<left<<setw(16)<<"      Fives"<<"\u2551"<<right<<setw(7)<<*sFives<<"     \u2551\u255f\u2508\u2508\u2508\u2508\u2508\u2508\u2508"
            "\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u256b\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508"
            "\u2508\u2508\u2508\u2508\u2508\u2562"<<endl;
    
    cout<<"\t\u255f\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u256b\u2508\u2508"
            "\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2562\u2551"<<left<<setw(16)<<"  LG Straight"<<"\u2551"<<right<<setw(9)<<*sLgSt<<"      \u2551"<<endl;
 
    //****************************SIXES - SUM OF ALL 6'S***************************************************************************************************************************
    cout<<"\t\u2551"<<left<<setw(16)<<"      Sixes"<<"\u2551"<<right<<setw(7)<<*sSixes<<"     \u2551\u2551"<<left<<setw(16)<<" (sequence of 5)"<<"\u2551"<<right<<setw(18)<<"\u2551"<<endl;
    ...
    cout<<"\t\u2551"<<left<<setw(16)<<"      TOTAL"<<"\u2551"<<right<<setw(7)<<*sTotNum<<"     \u2551\u2551"<<left<<setw(16)<<"     Yahtzee"<<"\u2551"<<right
            <<setw(9)<<*sYtz<<"      \u2551"<<endl;
    ...
    cout<<"\t\u2551"<<left<<setw(16)<<" BONUS (+35pts)"<<"\u2551"<<right<<setw(7)<<*sBonUS<<"     \u2551\u2551"<<left<<setw(16)<<"     Chance"<<"\u2551"<<right
            <<setw(9)<<*sChc<<"      \u2551"<<endl;
    ...
    cout<<"\t\u255f\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u256c\u2550\u2550"
            ...
            <<setw(2)<<*sYb1<<"\u250a"<<right<<setw(2)<<*sYb2<<"\u250a"<<setw(2)<<*sYb3<<"\u250a"<<setw(2)<<*sYb4<<"\u2551"<<endl;
   
    //****************************TOTAL OF "UPPER" SECTION - TOTAL SCORE + BONUS*****************************************************
    cout<<"\t\u2551"<<left<<setw(16)<<"    TOTAL OF"<<"\u2551"<<right<<setw(7)<<*sTotUS<<"     \u2551\u2551"<<left<<setw(16)<<"      Bonus"<<
            "\u255f\u2508\u2508\u2508\u2534\u2508\u2508\u2508\u2534\u2508\u2508\u2508\u2534\u2508\u2508\u2508\u2562"<<endl;
    cout<<"\t\u2551"<<left<<setw(16)<<"\"UPPER\" SECTION"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<right<<setw(19)<<"\u2551"<<right<<setw(9)<<*sYbTot
            <<"      \u2551"<<endl;
    ...
    cout<<"\t\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550"
            ...
            <<right<<setw(9)<<*sTotLS<<"      \u2551"<<endl;
    cout<<"\t\u2551"<<right<<setw(28)<<"SCORECARD INPUT CODES    "<<"\u2551 \u2551"<<left<<setw(16)<<"\"LOWER\" SECTION"<<"\u2551"<<right<<setw(18)<<"\u2551"<<endl;
    
    cout<<"\t\u2551"<<left<<setw(11)<<" 1 = Aces "<<right<<setw(17)<<" a/b = 3/4 kind "<<"\u2551 \u2560"<<"\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550"
            "\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u256c\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550"
            "\u2550\u2550\u2550\u2550\u2563"<<endl;
    
    
    //*****************************REPEAT OF "UPPER" SECTION TOTAL****************************************************
    cout<<"\t\u2551"<<left<<setw(11)<<" 2 = Twos"<<right<<setw(17)<<" c = Full House "<< "\u2551 \u2551"<<left<<setw(16)<<"    TOTAL OF"<<"\u2551"<<right<<setw(9)<<*sTotUS<<"      \u2551"<<endl;
    cout<<"\t\u2551"<<left<<setw(11)<<" 3 = Threes"<<right<<setw(17)<<" d = SM straight "<<"\u2551 \u2551"<<left<<setw(16)<<"\"UPPER\" SECTION"<<"\u2551"<<right<<setw(18)<<"\u2551"<<endl;
    
     cout<<"\t\u2551"<<left<<setw(11)<<" 4 = Fours"<<right<<setw(17)<<" e = LG straight "<<"\u2551 \u2560"<<"\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550"
            "\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u256c\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550"
            "\u2550\u2550\u2550\u2550\u2563"<<endl;
    
    //*****************************GRAND TOTAL - SUM OF "UPPER" AND "LOWER" SECTIONS*********************************
    cout<<"\t\u2551"<<left<<setw(11)<<" 5 = Fives"<<right<<setw(17)<<" f = Yahtzee "<<"\u2551 \u2551"<<left<<setw(16)<<"      GRAND"<<"\u2551"<<right<<setw(9)<<*sGrTot<<"      \u2551"<<endl;
    cout<<"\t\u2551"<<left<<setw(11)<<" 6 = Sixes"<<right<<setw(17)<<" g = Chance "<<"\u2551 \u2551"<<left<<setw(16)<<"      TOTAL"<<"\u2551"<<right<<setw(18)<<"\u2551"<<endl;
