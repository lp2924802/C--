   ...
   //Declare local variables
    ...
    for (roll=1; roll<=nRolls; roll++){
        ...
        if (rFive == true)
            refDie5 = rand()%6+1;
        //List Roll Outcome
        cout<<"Roll #"<<roll<<": "<<refDie1<<", "<<refDie2<<", "<<refDie3<<", "
    ...
    while (keep=='y' || keep=='Y'){
        ...
        if (yesInt==1){
            ...
            if (keepD=='y' || keepD=='Y'){
                ...
                pick1 = openBr.append(holdNum);
                rDie1 = false;
                cout<<"Current Roll: "<<die1<<", "<<die2<<", "<<die3<<", "<<die4<<", "<<die5<<endl;
            }
            ...
            cout<<"You decided not to keep any more dice."<<endl;
        }
        else{
            cout<<"This wasn't supposed to happen, debug this."<<endl;
        }
