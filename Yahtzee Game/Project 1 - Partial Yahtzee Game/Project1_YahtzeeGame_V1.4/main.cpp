 ...
 * Purpose: Project 1: Yahtzee Game. Rolling dice, selecting/returning dice,   *
 *              and rolling / not rolling dice all works! The game itself is   *
 *              officially functional; now the "back half" of the game (aka:   *
 *              scoring the dice and depicting it on the scorecard) just       *
 *              needs to be coded. The program itself is also being "cleaned   *
 *              up" in this version to improve its overall logic, efficiency,  *
 *              and readability.                                               *
 ******************************************************************************/
