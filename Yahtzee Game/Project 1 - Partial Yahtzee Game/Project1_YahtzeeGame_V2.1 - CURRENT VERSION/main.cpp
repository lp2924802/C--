 ...
 * Purpose: Project 1: Yahtzee Game. New game format with a file representing  *
 *                     the scorecard instead of a function. Scoring logic is   *
 *                     still being coded in.                                   *
 ******************************************************************************/
...
int main(int argc, char** argv) {
    ...
    //Total for 1-6's, bonus points, total for upper section, initialized to zero
    bool full1US=false, full2US=false, full3US=false, full4US=false, full5US=false, 
            full6US=false;//If 1-6 spots taken, initialized to false/open
    //**************************************************************************
...
char getIntro(fstream &card){
    ...
    cout<<"\t\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550"
            ...
            "\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550"
            "\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n";
    cout<<"\t\u2551"<<left<<setw(63)<<"                    Ready to play? (Y/N) "
 ...
 *  Description:  This function displays a blank Yahtzee Scorecard that the    *
 *                player will place their scores into throughout the game.     *
 *                In theory, this function should only be called once at the   *
...
void getCard(fstream &card){
    ...
    card<<"\t\u2551"<<left<<setw(16)<<"      Aces"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<left<<setw(16)<<"  3 of a kind"<<"\u2551"<<right<<setw(19)<<"\u2551\n";
    ...
    card<<"\t\u2551"<<left<<setw(16)<<"      Twos"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<left<<setw(16)<<"  4 of a kind"<<"\u2551"<<right<<setw(19)<<"\u2551\n";
    ...
    card<<"\t\u2551"<<left<<setw(16)<<"     Threes"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<left<<setw(16)<<"   Full House"<<"\u2551"<<right<<setw(19)<<"\u2551\n";
    ...
    card<<"\t\u2551"<<left<<setw(16)<<"      Fours"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<left<<setw(16)<<"  SM Straight"<<"\u2551"<<right<<setw(19)<<"\u2551\n";
    
    card<<"\t\u255f\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u256b\u2508\u2508"
            "\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2562\u2551"<<left<<setw(16)<<" (sequence of 4)"<<"\u2551"<<right<<setw(19)<<"\u2551\n";
    
    //****************************FIVES - SUM OF ALL 5'S********************LARGE STRAIGHT - 40 PTS IF SEQUENCE OF 5*************************
    card<<"\t\u2551"<<left<<setw(16)<<"      Fives"<<"\u2551"<<right<<setw(18)<<"\u2551\u255f"<<"\u2508\u2508\u2508\u2508\u2508\u2508\u2508"
            "\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u256b\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508"
            "\u2508\u2508\u2508\u2508\u2508\u2562\n";
    
    card<<"\t\u255f\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u256b\u2508\u2508"
            "\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2508\u2562\u2551"<<left<<setw(16)<<"  LG Straight"<<"\u2551"<<right<<setw(19)<<"\u2551\n";
 
    //****************************SIXES - SUM OF ALL 6'S***************************************************************************************************************************
    card<<"\t\u2551"<<left<<setw(16)<<"      Sixes"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<left<<setw(16)<<" (sequence of 5)"<<"\u2551"<<right<<setw(19)<<"\u2551\n";
    ...
    card<<"\t\u2551"<<left<<setw(16)<<"      TOTAL"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<left<<setw(16)<<"     Yahtzee"<<"\u2551"<<right
            <<setw(19)<<"\u2551\n";
    ...
    card<<"\t\u2551"<<left<<setw(16)<<" BONUS (+35pts)"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<left<<setw(16)<<"     Chance"<<"\u2551"<<right
            <<setw(19)<<"\u2551\n";
    ...
    card<<"\t\u255f\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u256c\u2550\u2550"
            ...
            <<setw(6)<<"\u250a"<<right<<setw(6)<<"\u250a"<<setw(6)<<"\u250a"<<setw(7)<<"\u2551\n";
   
    //****************************TOTAL OF "UPPER" SECTION - TOTAL SCORE + BONUS*****************************************************
    card<<"\t\u2551"<<left<<setw(16)<<"    TOTAL OF"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<left<<setw(16)<<"      Bonus"<<
            "\u255f\u2508\u2508\u2508\u2534\u2508\u2508\u2508\u2534\u2508\u2508\u2508\u2534\u2508\u2508\u2508\u2562\n";
    card<<"\t\u2551"<<left<<setw(16)<<"\"UPPER\" SECTION"<<"\u2551"<<right<<setw(18)<<"\u2551\u2551"<<right<<setw(19)<<"\u2551"<<right<<setw(19)<<"\u2551\n";
    ...
    card<<"\t\u2551"<<left<<setw(11)<<" 2 = Twos"<<right<<setw(17)<<" c = Full House "<< "\u2551 \u2551"<<left<<setw(16)<<"    TOTAL OF"<<"\u2551"<<right<<setw(19)<<"\u2551\n";
    ...
    card<<"\t\u2551"<<left<<setw(11)<<" 5 = Fives"<<right<<setw(17)<<" f = Yahtzee "<<"\u2551 \u2551"<<left<<setw(16)<<"      GRAND"<<"\u2551"<<right<<setw(19)<<"\u2551\n";
...
string * numLb(int die){
    ...
    static string * numb;
    string hold; //Holder string to append space onto integer for better formatting
    
    hold = to_string(die); //Convert integer to string
    hold = hold.append(" "); //Append a space onto the string for better formatting
